...
/*
 ...
 Realizar ell juego de la ruleta rusa de agua ej Java.Como muchos saben,el juego se trata de un número de jugadores
 que con un revolver de agua,el cual posee una sola carga de agua se dispara y se moja.Las clases por hacer del juego
 son las siguientes:
 Clase Resolver de agua:esta clase posee los siguientes atributos:posición actual(la posición del tambor donde se 
 encuentra el agua).Estas dos posiciones,se generaran aleatoriamente.
 Métodos:
